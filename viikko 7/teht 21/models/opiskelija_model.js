...
const opiskelija = {
  ...
  getById: function(id, callback) {
    return db.query('select * from opiskelija where idOpiskelija=?', [id], callback);  // Muutettu id_opiskelija -> idOpiskelija
  },
  ...
  delete: function(id, callback) {
    return db.query('delete from opiskelija where idOpiskelija=?', [id], callback);  // Muutettu id_opiskelija -> idOpiskelija
  },
  update: function(id, opiskelija, callback) {
    return db.query(
      'update opiskelija set Etunimi=?, Sukunimi=?, Luokkatunnus=?, Osoite=? where idOpiskelija=?',  // Muutettu id_opiskelija -> idOpiskelija
